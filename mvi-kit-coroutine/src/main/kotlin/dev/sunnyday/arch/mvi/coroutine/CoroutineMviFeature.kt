...
import dev.sunnyday.arch.mvi.coroutine.ktx.takeUntil
...
internal class CoroutineMviFeature<State : Any, InputEvent : Any, Event : Any, SideEffect : Any>(
    ...
    override val state: ObservableState<State>
