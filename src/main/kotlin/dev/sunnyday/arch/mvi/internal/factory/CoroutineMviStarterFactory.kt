...
object CoroutineMviStarterFactory {
    ...
    fun <State : Any, InputEvent : Any, Event : Any, SideEffect : Any> createStarter(
        ...
        return MviProcessorStarter { initialState ->
            val stateMachine = CoroutineMviStateMachineFactory.createStateMachine(
                coroutineScope = coroutineScope,
            ...
            val processor = CoroutineMviProcessorFactory.createProcessor(
                coroutineScope = coroutineScope,
